...
HB_Discharge_Type <- read_csv(dischargetypeshb.csv)
HB_Deprivation <- read_csv(deprivation/csv)
library(readr)
activity_readmissions <- read_csv("data/New folder/activity-readmissions.csv")
View(activity_readmissions)
```
